        ...
        <div className="grid gap-3">
          {loading ? (
            ...
            clients.map((client, index) => (
              <article
                key={client.name}
                className="grid gap-4 rounded-[20px] border border-[#e7eaf3] bg-white p-5 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:grid-cols-[56px_1fr_repeat(3,0.65fr)_120px] md:items-center"
              >
